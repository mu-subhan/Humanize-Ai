...
const Cards = () => {
  return (
    <div className="max-w-full min-h-screen bg-white font-[Poppins] ">
        <div className='flex flex-col justify-center'>
        <h1 className="text-2xl font-bold text-center py-10">
  Discover AIHumanizer's Flexible Pricing and Plans
</h1>
<p className='flex items-center justify-center text-xl font-[600]'>
...
* Plus applicable taxes</p>
  ...
  {/* first card */}
        <div
  className="rounded-lg shadow-md p-10 flex flex-col min-h-[700px]"
  style={{
    borderWidth: '1px',
    borderStyle: 'dashed',
    borderColor: 'black',
...
<ul className="space-y-5 py-12 px-3 list-inside list-disc">
  ...
  <li className='w-full sm:w-52 '>
    Ghost Model(Smarter) <span className="font-extrabold">20,000 words/month</span>
  </li>
  <li className='w-full sm:w-52'>
    Ninja Model(Faster) <span className="font-extrabold">Unlimited Words</span>
  </li>
...
<div
  className="rounded-lg shadow-lg p-10 flex flex-col min-h-[700px] bg-indigo-100"
>
  {/* Popular Badge */}
  ...
  {/* Features List */}
  <ul className="space-y-5 py-12 px-3 list-disc list-inside">
    <li>
      Rewrites <span className="font-extrabold">400</span> words per process
    </li>
    <li className="w-full sm:w-52">
...
<div
  className="rounded-lg shadow-md p-8 flex flex-col min-h-[700px]"
  style={{
    borderWidth: '1px',
    borderStyle: 'dashed',
    borderColor: 'black',
