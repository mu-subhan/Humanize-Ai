...
const Cards = () => {
  return (
    <div className="max-w-full min-h-screen bg-white font-[Poppins] px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-16 lg:grid-cols-3 sm:grid-cols-1 w-full max-w-7xl mx-auto py-14">
  {/* First card */}
  <div
    className="rounded-lg shadow-md p-10 flex flex-col min-h-[400px] sm:min-h-[600px] lg:min-h-[700px] border border-dashed border-black"
  >
    {/* Header */}
  ...
  {/* Second card */}
  <div
    className="rounded-lg shadow-lg p-10 flex flex-col min-h-[400px] sm:min-h-[600px] lg:min-h-[700px] bg-indigo-100"
  >
    {/* Popular Badge */}
    ...
    <button className="bg-[#00159b] text-white mt-6 py-3 px-6 rounded-ld shadow-xl font-bold">
      Choose Standard
    </button>
  </div>
