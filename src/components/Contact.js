...
const Contact = () => {
  return (
    <header className="text-center py-16 bg-coolColor h-auto font-sans">
      <h1 className="text-4xl font-bold text-darkBlue">Contact Us</h1>
      <p className="text-black px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 my-10 text-justify text-base sm:text-lg md:text-xl">
