...
const Contact = () => {
  return (
    <header className="text-center py-20 bg-coolColor h-auto"> {/* Set height to auto */}
      <h1 className="text-4xl font-bold text-darkBlue">Contact Us</h1>
      <p className="text-black mt-8 px-4 sm:px-6 md:px-10 lg:px-20 mx-auto max-w-2xl"> {/* Center with max width */}
