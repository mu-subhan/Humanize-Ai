...
const Benefits = () => {
  return (
    <div className="bg-[#E7EAF0] py-24 sm:px-12 lg:px-24 xl:px-20 font-[Poppins]">
      {/* First Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-0">
        {/* Left Column */}
        <h2 className="text-3xl text-center md:text-left lg:w-2/3 md:text-4xl font-bold">
          What Are The Benefits of our<br />
          AI to Human Text Converter?
        </h2>
        {/* Right Column */}
        <p className="sm:text-lg text-center md:text-left leading-relaxed text-black">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-0 pt-16 md:pt-40">
        ...
        {/* Right Column */}
        <div className="sm:text-lg text-center md:text-left leading-relaxed text-black">
          <p className="mb-4">
